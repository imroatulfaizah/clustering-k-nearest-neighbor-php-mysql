...
<?php 
$per_hal=10;
$jumlah_record=mysql_query("SELECT COUNT(*) from dealer");
...
<table class="table table-hover">
	...
	if(isset($_GET['cari'])){
		...
		$brg=mysql_query("select * from dealer where nama like '$cari' or jenis like '$cari'");
	}else{
		$brg=mysql_query("select * from dealer limit $start, $per_hal");
	}
	$no=1;
