...
<table class="table table-hover">
	<tr>
		...
		<th class="col-md-2">Nama Dealer</th>
	...
	if(isset($_GET['cari'])){
		...
		$brg=mysql_query("SELECT ts.id, ts.id_dealer, ts.id_merk,ts.id_type, ts.dp, ts.kontribusi, ts.nama_grade, td.nama_dealer, tt.nama_type, tm.nama_merk FROM data_training ts, dealer td, type tt, merk tm where ts.id_dealer=td.id_dealer && ts.id_type=tt.id_type && ts.id_merk=tm.id_merk order by id asc limit $start, $per_hal");
	}
	$no=1;
